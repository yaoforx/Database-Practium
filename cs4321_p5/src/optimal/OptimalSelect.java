...
/**
 * OptimalSelect class implements pushing selection for query optimization
 * @author Yao Xiao
 */
public class OptimalSelect {
    ...
    /**
     * This function calculate expression and return the cost info for selecting current index
     *
     * @param tableName
     * @param expression
     * @return Indexinfo if should select, null if should not
     */
